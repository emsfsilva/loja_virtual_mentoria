...
public class TarefaAutomatizadaService {
	...
	@Scheduled(cron = "0 0 11 * * *", zone = "America/Sao_Paulo") /*Roda toda 11h da manhã*/
	public void notificarUserTrocaSenha() throws UnsupportedEncodingException, MessagingException, InterruptedException {
		...
		for (Usuario usuario : usuarios) {
			...
			msg.append("Esta na hora de trocar a senha, já passou 90 dias de validade").append("<br/>");
			msg.append("Troque sua senha a loja virtural do Alex = JDEV Treinamento");
