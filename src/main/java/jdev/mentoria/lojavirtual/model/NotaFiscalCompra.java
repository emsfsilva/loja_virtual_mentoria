...
public class NotaFiscalCompra implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_nota_fiscal_compra") // Info Padrao
	private Long id;
	...
	@ManyToOne(targetEntity = Pessoa.class) //Muitas notas para uma Pessoa
	@JoinColumn(name = "pessoa_id", nullable = false,
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "pessoa_fk"))
	private Pessoa pessoa;
	
	
	@ManyToOne //Muitas contas a receber para uma Pessoa
